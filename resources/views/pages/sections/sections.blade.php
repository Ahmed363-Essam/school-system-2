                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td> {{ $list_Sections->sections->Name_Class }} </td>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Grade_id" class="custom-select" id="ajax_select"
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"  class="custom-select class_id_ajax">
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <select class="form-select" multiple aria-label="multiple select example" name="teacher_id[]">
